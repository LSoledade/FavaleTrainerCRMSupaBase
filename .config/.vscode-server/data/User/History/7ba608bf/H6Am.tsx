...
export function FavaleIAPage() {
  ...
  return (
    <div className="h-screen w-full flex bg-background overflow-hidden">
      ...
      <div className="flex-1 flex flex-col h-full min-w-0 bg-card rounded-xl shadow-sm border border-border overflow-hidden">
        {currentConversation ? (
          <>
            {/* Header do chat - Layout fixo */}
            <div className="p-4 border-b border-border bg-card flex-shrink-0 rounded-t-xl">
