...
import { Send, Bot, User, Plus, MessageSquare, Trash2, MoreVertical } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export function FavaleIAPage() {
  ...
  useEffect(() => {
    // Só faz scroll quando há mensagens na conversa atual e não quando cria nova conversa
  ...
  return (
    <div className="h-screen w-full flex bg-background overflow-hidden p-4">
      {/* Sidebar com conversas - Layout fixo */}
      <div className="w-80 border-r border-border bg-card flex flex-col h-full rounded-l-xl shadow-sm">
        {/* Header da sidebar - fixo */}
        <div className="p-4 border-b border-border flex-shrink-0 rounded-tl-xl bg-card">
      ...
      <div className="flex-1 flex flex-col h-full min-w-0 bg-card rounded-r-xl shadow-sm border border-border overflow-hidden ml-4">
        {currentConversation ? (
          <>
            {/* Header do chat - Layout fixo */}
            <div className="p-4 border-b border-border bg-card flex-shrink-0 rounded-tr-xl">
            ...
            <div className="p-4 border-t border-border bg-card flex-shrink-0 rounded-br-xl">
          ...
          <div className="flex-1 flex items-center justify-center bg-background h-full overflow-hidden rounded-r-xl">
